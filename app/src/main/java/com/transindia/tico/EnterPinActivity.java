...
public class EnterPinActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView pin1_txt,pin2_txt,pin3_txt,pin4_txt;
    ...
    private void InitView() {
        ...
        pin1_txt = (TextView)findViewById(R.id.pin1_txt);
        pin2_txt = (TextView)findViewById(R.id.pin2_txt);
        pin3_txt = (TextView)findViewById(R.id.pin3_txt);
        pin4_txt = (TextView)findViewById(R.id.pin4_txt);
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.btn_next:
                Intent intent = new Intent(EnterPinActivity.this,PaymentSuccessActivity.class);
